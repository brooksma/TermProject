...
public class Runes {
	...
	/**The tenth rune. */
	private final Rune algiz = new Rune("Algiz", 7, false);
	/** A set of keywords for algiz. */
	private final String[] alkeys = {"safe", "safety", "unsafe",
			"scared", "afraid", "following", "unknown"};
	...
	/**The fourteenth rune. */
	private final Rune kano = new Rune("Kano", 7, true);
	/** A set of keywords for kano. */
	private final String[] kkeys = {"stomach", "boat",
			"boating", "fishing", "closed", "open",
			"door"};
	...
	/**The sixteenth rune. */
	private final Rune berkana = new Rune("Berkana", 5, false);
	/** A set of keywords for berkana. */
	private final String[] bkeys = {"pregnant", "motivation",
			"religion", "old", "pain"};

	/**The seventeenth rune. */
	private final Rune ehwaz = new Rune("Ehwaz", 7, true);
	...
	private final Rune othila = new Rune("Othila", 10, true);
	/** A set of keywords for othila. */
	private final String[] okeys = {"struggling", "thoughts",
			"work", "working", "tough", "hard",
			"project", "homework", "paper"};

	/**The twenty-third rune. */
	private final Rune isa = new Rune("Isa", 8, false);
	/** A set of keywords for isa. */
	private final String[] iskeys = {"ice", "icey", "standoff",
			"not", "argument", "arguing", "listening", "fight"};
